...
/**
 * ProductopaginaDos filter form base class.
 *
 ...
 */
abstract class BaseProductopaginaDosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('productopagina_dos_filters[%s]');
