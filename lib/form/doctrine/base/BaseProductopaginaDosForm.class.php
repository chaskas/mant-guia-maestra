...
/**
 * ProductopaginaDos form base class.
 *
 * @method ProductopaginaDos getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProductopaginaDosForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('productopagina_dos[%s]');
